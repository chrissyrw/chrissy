...
export class MissionDirector {
  ...
  baseCandidates(){return[
    {id:'ai-market-run',title:'Market Rush',description:'Deliver a package to Kimironko while city traffic is building.',objective:{type:'location',x:-16,z:14,radius:8},reward:500,reputation:7,tags:['traffic','crowd'],district:'Kimironko'},
    {id:'ai-night-patrol',title:'Night Circuit',description:'Reach Nyarutarama after dark without abandoning your drive.',objective:{type:'night-location',x:54,z:42,radius:10},reward:650,reputation:10,tags:['night'],district:'CBD'},
    {id:'ai-storm-run',title:'Storm Run',description:'Reach Remera Fuel while the weather is stormy.',objective:{type:'storm-location',x:54,z:-44,radius:10},reward:850,reputation:14,tags:['storm'],district:'Nyabugogo'},
