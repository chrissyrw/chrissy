...
export class CrewProtectionEconomySystem{
 ...
 heat(e={}){const district=e.district||this.findDistrict(e.crewId);const d=this.state.districts[district];if(d)d.heat=CLAMP(d.heat+.12);}
 ...
 findDistrict(id){const t=this.game.state.get().crewTerritory?.districts||{};return Object.entries(t).find(([,v])=>v.crewId===id)?.[0];}
