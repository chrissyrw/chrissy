import { LivingNPCEconomySystem } from './LivingNPCEconomySystem.js';
...
export class CityResponseSystem{
 constructor(game,cascade,ecosystem){this.game=game;this.cascade=cascade;this.ecosystem=ecosystem;this.tick=0;this.state=game.state.get().cityResponse||{districts:{},active:[],adaptation:0,updatedAt:0};this.livingEconomy=new LivingNPCEconomySystem(game);this.bind();this.sync();}
